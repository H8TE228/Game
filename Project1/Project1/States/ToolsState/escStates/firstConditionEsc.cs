...
{
    public class firstConditionEsc : State
    {
        ...
        public firstConditionEsc(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content, StateInfo stateInfo) : base(game1, graphicsDevice, content)
        {
        ...
        {
            _game.ChangeState(new firstCondition(_game, _graphicsDevice, _content, _stateInfo));
        }
