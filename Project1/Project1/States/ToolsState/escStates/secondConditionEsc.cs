...
{
    public class secondConditionEsc : State
    {
        ...
        public secondConditionEsc(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content, StateInfo stateInfo) : base(game1, graphicsDevice, content)
        {
        ...
        {
            _game.ChangeState(new secondCondition(_game, _graphicsDevice, _content, _stateInfo));
        }
