...
namespace Project1.States.ToolsState.escStates
{
    public class escState : State
    {
        ...
        public escState(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content, StateInfo stateInfo) : base(game1, graphicsDevice, content)
        {
        ...
        {
            _game.ChangeState(new StartState(_game, _graphicsDevice, _content, _stateInfo));
        }
