...
namespace Project1.States.lvlState
{
    public class lastFight : State
    {
        ...
        public lastFight(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content) : base(game1, graphicsDevice, content)
        {
            ...
            _imageTexture = _content.Load<Texture2D>("ggEnemy/father");
            ...
            _components = new List<Component>()
            {
                ...
                new ImageComponent(_imageTexture, new Vector2(1000, 0), _characterScale),
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _enemyHealthText = $"Здоровье отца: {_enemyHP}";
        }
    }
}
