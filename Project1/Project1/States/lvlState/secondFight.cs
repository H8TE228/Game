...
{
    public class secondFight : State
    {
        ...
        private float _characterScale = 0.37f;
        ...
        public secondFight(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content) : base(game1, graphicsDevice, content)
        {
            ...
            _heroHP = _hero.HealthPoints + 100;
            ...
            _enemyHP = _enemy.HealthPoints + 100;
            ...
            _imageTexture = _content.Load<Texture2D>("ggEnemy/zombie");
        ...
        private async void regenButton_Click(object sender, EventArgs e)
        {
            ...
            if (_heroHP < _hero.HealthPoints + 60)
            {
                _heroHP = Math.Min(_heroHP + _heroRegen + 45 - _heroDamageTaken, _hero.HealthPoints + 65);
            }

            if (_heroRegen < 0)
                _regenText = $"Вы восстановили {_heroRegen} единиц здоровья";
            else
                _regenText = $"Вы восстановили {_heroRegen + 45} единиц здоровья";
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _enemyHealthText = $"Здоровье зомби: {_enemyHP}";
        }
    }
}
