...
{
    internal class firstCondition : State
    {
        ...
        {
            "Так, отдной проблемой стало меньше.",
            "Теперь я могу выйти из го...",
            "Ах, черт, от ворот же ключ же нужен.",
            "Надо поробовать обыскать охранников, может у них он будет",
            "Либо можно попробовать сломать силой...",
            "Сначала все же обыщу охранников.",
            "\"Теперь вам доступна новая способность \"Стрельба из лука\",\n она игнорирует броню врага, но можно сделать 3 выстрела.\"",
            "Также урон и здоровье персонажа увеличены на 30 и 7 соответственно",
            "У них ключа не оказалось,",
            "Надо подумать..."
        };
        ...
        public firstCondition(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content, StateInfo stateInfo = null) : base(game1, graphicsDevice, content)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (keyboardState.IsKeyDown(Keys.Escape))
            {
                ...
                _game.ChangeState(new firstConditionEsc(_game, _graphicsDevice, _content, currentStateInfo));
                return;
            }
