...
{
    public class unrealFight : State
    {
        ...
        private float _characterScale = 0.4f;
        ...
        public unrealFight(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content) : base(game1, graphicsDevice, content)
        {
            ...
            _enemyHP = _enemy.HealthPoints + 200;
            _enemyArmor = _enemy.Armor;

            #endregion

            _backgroundTexture = _content.Load<Texture2D>("Background/solider");
            _characterTexture = _content.Load<Texture2D>("ggEnemy/gg");
            _imageTexture = _content.Load<Texture2D>("ggEnemy/elite");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _enemyHealthText = $"Здоровье элитных стражников: {_enemyHP}";
        }
    }
}
