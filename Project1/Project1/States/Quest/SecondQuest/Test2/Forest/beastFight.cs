...
namespace Project1.States.Quest.SecondQuest.Test2.Forest
{
    public class beastFight : State
    {
        ...
        public beastFight(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content) : base(game1, graphicsDevice, content)
        {
            ...
            _enemyHP = _enemy.HealthPoints + 30;
            ...
            _imageTexture = _content.Load<Texture2D>("ggEnemy/coban");
            ...
            _components = new List<Component>()
            {
                ...
                new ImageComponent(_imageTexture, new Vector2(1000, 100), _characterScale),
                new ImageComponent(_imageTexture, new Vector2(1100, 100), _characterScale),
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (_enemyHP <= 0)
            {
                _game.ChangeState(new afterBeast(_game, _graphicsDevice, _content));
            }
            ...
            _enemyHealthText = $"Здоровье лесных кабанов: {_enemyHP}";
        }
    }
}
