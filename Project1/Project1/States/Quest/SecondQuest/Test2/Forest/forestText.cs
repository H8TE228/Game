...
{
    internal class forestText : State
    {
        ...
        {
            "Я все-таки решил пойти через лес,",
            "Надеюсь, что ничего страшного не произойдет..."
        };
        ...
        public forestText(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content, StateInfo stateInfo = null) : base(game1, graphicsDevice, content)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (mouseState.LeftButton == ButtonState.Pressed && previousMouseState.LeftButton == ButtonState.Released)
            {
                ...
                if (_textIndex == 2)
                {
                    _game.ChangeState(new beastFight(_game, _graphicsDevice, _content));
                }
            }
