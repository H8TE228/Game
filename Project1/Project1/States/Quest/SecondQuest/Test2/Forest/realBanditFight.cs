...
{
    public class realBanditFight : State
    {
        ...
        public realBanditFight(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content) : base(game1, graphicsDevice, content)
        {
            ...
            _enemyHP = _enemy.HealthPoints + 80;
