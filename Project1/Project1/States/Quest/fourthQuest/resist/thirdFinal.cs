...
internal class thirdFinal : State
{
    ...
    private string[] _texts =
    {
        ...
        "На этом твое приключение заканчивается.",
        "Увидимся в аду..."
    };
    ...
    public thirdFinal(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content, StateInfo stateInfo = null) : base(game1, graphicsDevice, content)
    {
