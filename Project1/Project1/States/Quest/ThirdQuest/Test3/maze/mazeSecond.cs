...
{
    internal class mazeSecond : State
    {
        ...
        public mazeSecond(Game1 game1, GraphicsDevice graphicsDevice, ContentManager content) : base(game1, graphicsDevice, content)
        {
        ...
        {
            _game.ChangeState(new mazeFourth(_game, _graphicsDevice, _content));
        }
